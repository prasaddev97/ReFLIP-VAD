...
parser = argparse.ArgumentParser(description='ReFLIPVAD')
...
parser.add_argument('--train-list', default='list/ucf_ReFLIP_rgb.csv')
parser.add_argument('--test-list', default='list/ucf_ReFLIP_rgbtest.csv')
